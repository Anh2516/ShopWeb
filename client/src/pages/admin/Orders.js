                ...
                {filteredOrders.map((order) => (
                  <tr key={order.id}>
                    ...
                    <td>
                      ...
                      >
                        {detailLoading && selectedOrderId === order.id
                          ? "Đang tải..."
                          : "Xem chi tiết"}
                      </button>
                    </td>
            ...
            >
              ...
              <div className="order-detail-section">
                ...
                <div className="order-detail-grid">
                  <div>
                    <strong>Họ tên:</strong> {orderDetail.user_name || "N/A"}
                  </div>
                  <div>
                    <strong>Email:</strong> {orderDetail.user_email || "N/A"}
                  </div>
                  <div>
                    <strong>Số điện thoại:</strong>{" "}
                    {orderDetail.user_phone || "N/A"}
                  </div>
                  <div>
                    <strong>Địa chỉ:</strong>{" "}
                    {orderDetail.user_address || orderDetail.shipping_address}
                  </div>
                </div>
              </div>
              ...
              <div className="order-detail-section">
                ...
                <div className="order-detail-grid">
                  ...
                  <div>
                    <strong>Phương thức thanh toán:</strong> Số dư ví
                  </div>
                  <div>
                    <strong>Cổng thanh toán:</strong> Số dư ví
                  </div>
                  <div>
