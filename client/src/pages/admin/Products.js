                ...
                {editingProduct && (
                  <div className="form-group">
                            ...
                            try {
                              ...
                              if (response.data.success && response.data.url) {
                                try {
                                  ...
                                  setProductImages([
                                    ...productImages,
                                    addResponse.data.image,
                                  ]);
                                  alert("Upload và thêm ảnh thành công!");
                                } catch (addError) {
                                  setNewImageUrl(response.data.url);
                                  alert(
                                    'Upload thành công! URL đã được điền sẵn, vui lòng click "Thêm URL" để thêm vào gallery.'
                                  );
                                }
                              }
                            } catch (error) {
                    ...
                    {productImages.length === 0 && (
                      ...
                      >
                        Chưa có ảnh nào. Thêm ảnh để hiển thị trong trang chi
                        tiết sản phẩm.
                      </p>
                    )}
                  </div>
