...
const Inventory = () => {
  ...
  const totalStockValue = entries.reduce(
                  ...
                  <tr key={entry.id}>
                    ...
                    <td>
                      ...
                      {entry.supplier_contact && (
                        <div>{entry.supplier_contact}</div>
                      )}
                      {entry.supplier_email && (
                        <div>{entry.supplier_email}</div>
                      )}
                      {entry.supplier_address && (
                        <div>{entry.supplier_address}</div>
                      )}
                    </td>
        ...
        {showModal && (
          <div className="modal-overlay" onClick={closeModal}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              <h2>
                {editingEntry ? "Cập nhật phiếu nhập" : "Thêm phiếu nhập mới"}
              </h2>
